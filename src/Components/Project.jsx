...
function Project({ title, image, description, techstack, previewLink, githubLink }) {
    return (
        <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900 flex flex-col">
            <img src={image} alt="" loading="lazy" style={{ maxHeight: "300px", width: "100%" }} />
            <div className="bg-dark-card p-4 flex flex-col h-full">
                <h1 className="text-light-heading font-semibold text-lg">{title}</h1>
                <p className="text-content pt-4 font-light flex-grow">{description}</p>
                ...
                <div className="mt-auto">
                    ...
                    <div className="flex justify-between items-center mt-5">
                        <div className="flex items-center">
                            ...
                            {/* <a href={previewLink} target="_blank" rel="noreferrer noopener" className="underline pl-2 font-light text-white">
                Live Preview
              </a> */}
                        </div>
                        <div className="flex items-center">
                            ...
                            <a href={githubLink} target="_blank" rel="noreferrer noopener" className="underline pl-2 font-light text-white">
                                View Code
                            </a>
                        </div>
                    </div>
